...
<html>
	<head>
        ...
        <body  style="background-color:#E5E8E8;">
            <center>
                <h1>Country CRUD operations</h1>
            <li><a href="/CustomerApplication/country/list"  id='hide'>List</a></li>
            ...
            <div id="update" class="form-style-6" style="display:none;">
                ...
                <g:form controller="country">
                    <g:select name="oldCountry" from="${countryList}" optionValue="country" optionKey="id" class="input_fields"/>
                    <label>Enter new Country name</label>
                    <g:textField name="newCountry" class="input_fields"/><br/>
            ...
            <center><a href="/CustomerApplication/state/create" value="skip">Skip</a></center>
        </body>
</html>
